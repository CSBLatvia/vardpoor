...
varpoord <- function(Y, w_final,
  ...
  if (is.null(names(ID_level2))||(names(id)=="id")) setnames(id,names(ID_level2),"ID")
  ...
  if (names(ID_level1) == names(ID_level2)) setnames(id,names(ID_level2), paste(names(ID_level2), "_id", sep=""))
